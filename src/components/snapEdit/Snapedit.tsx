...
// // ─── CONFIG ──────────────────────────────────────────────────────────────────
// // Change this to your actual upload endpoint
...
//   // The annotation fabric canvas (transparent bg, drawn on top of the photo)
//   const canvasRef = useRef<HTMLCanvasElement | null>(null);
//   const fabricRef = useRef<fabric.Canvas | null>(null);
//   // The photo sits underneath in a plain <img> tag — never touched by eraser
...
//     applyTool(canvas, tool, color, size, fontSize);
...
//     applyTool(fabricRef.current, tool, color, size, fontSize);
//   }, [tool, color, size, fontSize]);
...
//       }
//     } else if (t === "eraser") {
//       // Eraser removes only drawn objects (strokes/text), not the background
//       canvas.isDrawingMode = true;
//       canvas.selection = false;
//       if (canvas.freeDrawingBrush) {
//         // Draw transparent — this erases on the annotation canvas only
//         canvas.freeDrawingBrush.color = "rgba(0,0,0,1)";
//         canvas.freeDrawingBrush.width = SIZE_MAP[s];
//       }
//       // We use destination-out compositing; see mouse:up handler below
//     } else if (t === "text") {
...
//   // ── Text tool: click to place IText ──────────────────────────────────────
//   useEffect(() => {
//     const canvas = fabricRef.current;
//     if (!canvas) return;
...
//       if (tool !== "text") return;
//       if (e.target) return; // clicked an existing object — let fabric handle it
...
//                   Click on the photo to place text.
//                 </p>
//               </Section>
//             )}
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl flex gap-3">
        ...
        {captured && (
          <div
            className="w-48 rounded-2xl p-3 text-white flex flex-col gap-3 shadow-2xl overflow-y-auto"
            style={{
              background: "#13152a",
              border: "1px solid rgba(255,255,255,0.06)",
              maxHeight: 460,
